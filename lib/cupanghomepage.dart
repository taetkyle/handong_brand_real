...
class _HomepageState extends State<Homepage> {
  ...
  Map<String, GlobalKey<NavigatorState>> _navigatorKeys = {
    "catagoris": GlobalKey<NavigatorState>(),
    "search": GlobalKey<NavigatorState>(),
    "home": GlobalKey<NavigatorState>(),
    "mycupang": GlobalKey<NavigatorState>(),
    "shoppingcart": GlobalKey<NavigatorState>()
  };
  int currentIndex = 2;
                            ...
                            child: Column(children: [
                              Row(
                                children: [
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/10.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/13.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/14.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/15.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.push(
                                            context,
                              ...
                              Row(
                                children: [
                                  IconButton(
                                      icon: Image.asset('assets/images/16.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/17.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/18.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/19.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/20.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/21.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/23.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/24.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/25.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/26.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/27.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                  ...
                                  IconButton(
                                      icon: Image.asset('assets/images/29.png'),
                                      iconSize: scroll_icon_size,
                                      onPressed: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
